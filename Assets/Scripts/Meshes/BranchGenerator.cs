...
public class BranchGenerator : MeshGenerator
{
    ...
    private readonly ProceduralFoliageStyle foliageType;
    ...
    private void AddFoliage(Quaternion rotation, Vector3 pos)
    {
        ...
        switch (foliageType)
        {
            case ProceduralFoliageStyle.Round:
                generator = new RoundLeavesGenerator(tree, filter.mesh, rotation);
                break;

            case ProceduralFoliageStyle.Flat:
                generator = new FlatLeavesGenerator(tree, filter.mesh, rotation);
                break;
